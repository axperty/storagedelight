...
public enum BlockEntityTypesRegistry {
    ...
    DRAWER_DOOR("drawer_door", DrawerDoorBlockEntity.class, DrawerDoorBlockEntity::new,
            BlocksRegistry.OAK_DRAWER_WITH_DOOR, BlocksRegistry.BIRCH_DRAWER_WITH_DOOR, BlocksRegistry.SPRUCE_DRAWER_WITH_DOOR,
            BlocksRegistry.JUNGLE_DRAWER_WITH_DOOR, BlocksRegistry.ACACIA_DRAWER_WITH_DOOR, BlocksRegistry.DARK_OAK_DRAWER_WITH_DOOR,
            BlocksRegistry.MANGROVE_DRAWER_WITH_DOOR, BlocksRegistry.CHERRY_DRAWER_WITH_DOOR, BlocksRegistry.BAMBOO_DRAWER_WITH_DOOR,
